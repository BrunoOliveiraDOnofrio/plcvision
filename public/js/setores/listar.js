...
const fillSetores = (dados) => {
    ...
    dados.map((setores) => {
        ...
        htmlString += ` <tr>
                            <td>${setores.id}</td>
                            <td>${setores.nome}</td>
                            <td>${setores.qtdSetor}</td>
                            <td class="central_viz_rem">
                                <button class="btn-visualizar" id="${setores.id}" onclick="modal(${setores.id},'${setores.nome}',${setores.qtdPlc},${setores.fabrica_consumidor_id})">
                            ...
                            <td class="central_viz_rem">
                                <button class="btn-remover" data-id="${fabricas.id}" onclick="excluir(${setores.id})">
